...
#
# Script generated by Vivado on Thu Jul 18 10:03:54 CEST 2024
# SW Build 5094488 on Fri Jun 14 08:57:50 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tanh_lut.sh
...
#
# Usage        : tanh_lut.sh
#                tanh_lut.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tanh_lut.sh [-reset_run]
#                tanh_lut.sh [-reset_log]
#                tanh_lut.sh [-help]
#
...
#                script (type 'tanh_lut.sh -help' for more information).
#
...
# script info
echo -e "tanh_lut.sh - Script generated by export_simulation (Vivado v2024.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tanh_lut.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tanh_lut xil_defaultlib.glbl -o tanh_lut_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tanh_lut_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alessandro/OneDrive/Documenti/Politecnico/Dottorato/Progetti/Vivado/DUAL-LSTM/HLSTM.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key tanh_lut_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tanh_lut_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tanh_lut.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tanh_lut.sh [-help]\n\
Usage: tanh_lut.sh [-step]\n\
Usage: tanh_lut.sh [-lib_map_path]\n\
Usage: tanh_lut.sh [-reset_run]\n\
Usage: tanh_lut.sh [-reset_log]\n\
Usage: tanh_lut.sh [-keep_index]\n\
Usage: tanh_lut.sh [-noclean_files]\n\n\

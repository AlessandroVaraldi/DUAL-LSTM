...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot tanh_lut xil_defaultlib.tanh_lut -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tanh_lut -key {Behavioral:sim_1:Functional:tanh_lut} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alessandro/Tools/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tanh_lut.wdb xsim.dir libdpi.so)

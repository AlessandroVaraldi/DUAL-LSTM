...
HD_PWD='C:/Users/aleva/OneDrive/Documenti/Politecnico/Dottorato/Progetti/Vivado/DUAL-LSTM/HLSTM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LSTM_net.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LSTM_net.tcl -notrace

...
HD_PWD='C:/Users/aleva/OneDrive/Documenti/Politecnico/Dottorato/Progetti/Vivado/DUAL-LSTM/HLSTM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LSTM_net.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LSTM_net.tcl

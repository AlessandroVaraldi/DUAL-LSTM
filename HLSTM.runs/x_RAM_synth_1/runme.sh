...
HD_PWD='C:/Users/aleva/OneDrive/Documenti/Politecnico/Dottorato/Progetti/Vivado/DUAL-LSTM/HLSTM.runs/x_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source x_RAM.tcl
